...
HD_PWD='D:/Documents/University/ENSC452/Folder/dkong_system/dkong_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dkong_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dkong_wrapper.tcl
