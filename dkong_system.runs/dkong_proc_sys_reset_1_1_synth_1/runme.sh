...
HD_PWD='C:/Users/Steven/Documents/HDL/vivado/dkong_system/dkong_system.runs/dkong_proc_sys_reset_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dkong_proc_sys_reset_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dkong_proc_sys_reset_1_1.tcl
