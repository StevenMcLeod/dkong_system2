...
HD_PWD='D:/Documents/University/ENSC452/Folder/dkong_system/dkong_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dkong_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dkong_wrapper.tcl -notrace
