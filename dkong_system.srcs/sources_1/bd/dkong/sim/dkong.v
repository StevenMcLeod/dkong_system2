...
(* CORE_GENERATION_INFO = "dkong,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=dkong,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=16,numReposBlks=16,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=8,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "dkong.hwdef" *) 
module dkong
   (BTNC,
    BTND,
    BTNL,
  ...
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire [7:0]dkong_system_wrapper_0_doutprogrom;
  ...
  dkong_axi_bram_ctrl_0_2 axi_bram_ctrl_0
       (.bram_addr_a(axi_bram_ctrl_0_bram_addr_a),
        .bram_clk_a(axi_bram_ctrl_0_bram_clk_a),
        .bram_en_a(axi_bram_ctrl_0_bram_en_a),
        .bram_rddata_a({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,dkong_system_wrapper_0_doutprogrom}),
  ...
  dkong_dkong_system_wrapper_0_0 dkong_system_wrapper_0
       (.addrprogrom(xlslice_0_Dout),
        .b_sig(dkong_system_wrapper_0_b_sig),
        .clkprogrom(axi_bram_ctrl_0_bram_clk_a),
        ...
        .debug_wait(1'b0),
        .dinprogrom(axi_bram_ctrl_0_bram_wrdata_a[7:0]),
        .doutprogrom(dkong_system_wrapper_0_doutprogrom),
        .enprogrom(axi_bram_ctrl_0_bram_en_a),
        ...
        .weprogrom(axi_bram_ctrl_0_bram_we_a[0]));
  ...
  dkong_proc_sys_reset_1_1 proc_sys_reset_2
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(processing_system7_0_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
  ...
  dkong_smartconnect_0_0 smartconnect_0
