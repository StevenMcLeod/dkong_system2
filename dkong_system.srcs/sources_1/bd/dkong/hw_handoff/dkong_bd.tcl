...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BANKSEL [ create_bd_port -dir I -from 1 -to 0 BANKSEL ]
  ...
  connect_bd_net -net debug_banksel_0_1 [get_bd_ports BANKSEL] [get_bd_pins dkong_system_wrapper_0/debug_banksel]
  ...
  connect_bd_net -net dkong_system_wrapper_0_debug_enables [get_bd_pins dkong_system_wrapper_0/debug_enables] [get_bd_pins mux4_0/ind]
