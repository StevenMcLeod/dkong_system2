...
#
# Generated by export_simulation on Fri Feb 28 16:07:41 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './obj_7e_rom.sh' script.

./obj_7e_rom.sh -reset_run
...
./obj_7e_rom.sh -noclean_files

For more information on the script, please type './obj_7e_rom.sh -help'.
