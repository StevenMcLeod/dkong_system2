...
#
# Generated by export_simulation on Tue Feb 18 23:43:37 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './tile_2n_prom.sh' script.

./tile_2n_prom.sh -reset_run
...
./tile_2n_prom.sh -noclean_files

For more information on the script, please type './tile_2n_prom.sh -help'.
