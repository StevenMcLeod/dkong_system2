...
#
# Generated by export_simulation on Thu Apr 02 13:42:33 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './tile_2n_banked_prom.sh' script.

./tile_2n_banked_prom.sh -reset_run
...
./tile_2n_banked_prom.sh -noclean_files

For more information on the script, please type './tile_2n_banked_prom.sh -help'.
