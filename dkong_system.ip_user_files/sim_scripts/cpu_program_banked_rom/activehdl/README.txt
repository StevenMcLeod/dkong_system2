...
#
# Generated by export_simulation on Thu Apr 02 12:40:41 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './cpu_program_banked_rom.sh' script.

./cpu_program_banked_rom.sh -reset_run
...
./cpu_program_banked_rom.sh -noclean_files

For more information on the script, please type './cpu_program_banked_rom.sh -help'.
