...
#
# Generated by export_simulation on Tue Mar 31 20:18:05 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './cpu_program_rom_dp.sh' script.

./cpu_program_rom_dp.sh -reset_run
...
./cpu_program_rom_dp.sh -noclean_files

For more information on the script, please type './cpu_program_rom_dp.sh -help'.
