...
#
# Generated by export_simulation on Wed Apr 01 21:29:07 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './tile_3n_banked_rom.sh' script.

./tile_3n_banked_rom.sh -reset_run
...
./tile_3n_banked_rom.sh -noclean_files

For more information on the script, please type './tile_3n_banked_rom.sh -help'.
