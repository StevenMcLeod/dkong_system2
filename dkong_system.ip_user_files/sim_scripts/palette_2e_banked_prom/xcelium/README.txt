...
#
# Generated by export_simulation on Wed Apr 01 21:18:41 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './palette_2e_banked_prom.sh' script.

./palette_2e_banked_prom.sh -reset_run
...
./palette_2e_banked_prom.sh -noclean_files

For more information on the script, please type './palette_2e_banked_prom.sh -help'.
