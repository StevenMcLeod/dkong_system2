...
#
# Generated by export_simulation on Tue Feb 18 23:42:48 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './tile_3n_rom.sh' script.

./tile_3n_rom.sh -reset_run
...
./tile_3n_rom.sh -noclean_files

For more information on the script, please type './tile_3n_rom.sh -help'.
