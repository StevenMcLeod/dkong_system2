...
#
# Generated by export_simulation on Tue Feb 18 23:47:09 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './palette_2e_prom.sh' script.

./palette_2e_prom.sh -reset_run
...
./palette_2e_prom.sh -noclean_files

For more information on the script, please type './palette_2e_prom.sh -help'.
