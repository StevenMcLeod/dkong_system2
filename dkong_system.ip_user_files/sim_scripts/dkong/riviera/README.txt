...
#
# Generated by export_simulation on Thu Apr 02 22:15:03 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './dkong.sh' script.
...
./dkong.sh -noclean_files

For more information on the script, please type './dkong.sh -help'.
