...
#
# Generated by export_simulation on Wed Apr 01 21:25:29 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './sou_3h_banked_rom.sh' script.

./sou_3h_banked_rom.sh -reset_run
...
./sou_3h_banked_rom.sh -noclean_files

For more information on the script, please type './sou_3h_banked_rom.sh -help'.
