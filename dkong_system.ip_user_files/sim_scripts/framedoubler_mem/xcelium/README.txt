...
#
# Generated by export_simulation on Sat Feb 22 15:19:39 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './framedoubler_mem.sh' script.

./framedoubler_mem.sh -reset_run
...
./framedoubler_mem.sh -noclean_files

For more information on the script, please type './framedoubler_mem.sh -help'.
