...
#
# Generated by export_simulation on Tue Feb 18 23:41:12 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './tile_3p_rom.sh' script.

./tile_3p_rom.sh -reset_run
...
./tile_3p_rom.sh -noclean_files

For more information on the script, please type './tile_3p_rom.sh -help'.
