...
#
# Generated by export_simulation on Wed Apr 01 21:10:11 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './obj_7c_banked_rom.sh' script.

./obj_7c_banked_rom.sh -reset_run
...
./obj_7c_banked_rom.sh -noclean_files

For more information on the script, please type './obj_7c_banked_rom.sh -help'.
