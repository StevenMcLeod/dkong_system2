...
module dkong
   (BTNC,
    ...
    VGA_R,
    VGA_VS);
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.BTNC RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.BTNC, INSERT_VIP 0, POLARITY ACTIVE_HIGH" *) input BTNC;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.BTND RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.BTND, INSERT_VIP 0, POLARITY ACTIVE_HIGH" *) input BTND;
  input BTNU;
  input [1:0]DIPSW;
  ...
  assign aux_reset_in_0_1 = BTND;
  assign debug_wait_0_1 = BTNU;
